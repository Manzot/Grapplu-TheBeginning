...
public class DemonBoss : BossUnit
{
    ...
    public void MoveToPlayer()
    {
        ...
        if(!enraged)
            rb.linearVelocity = new Vector2(dirTowardsTarget.x, 0) * speed * Time.fixedDeltaTime + new Vector2(0, rb.linearVelocity.y);
        else
        {
            ...
            rb.linearVelocity = new Vector2(dirTowardsTarget.x, 0) * speed * 2f * Time.fixedDeltaTime + new Vector2(0, rb.linearVelocity.y);
        }
