...
public class FlyingEnemy : EnemyUnit
{
    ...
    void AttackMove()
    {
        ...
        if (canAttack)
        {
            ...
            {
                rb.linearVelocity = directionToPlayer.normalized * speed * ATTACK_SPEED_MULTIPLIER * Time.fixedDeltaTime;
            }
            ...
            {
                if(!movingUp)
                    rb.linearVelocity = directionToPlayer.normalized * speed * Time.fixedDeltaTime;
            }
        }
        else
        {
    ...
    public void RandomMove()
    {
        ...
        else
        {
            if (!movingUp)
            {
                if (moveRight) rb.linearVelocity = new Vector2(1, RANDOM_Y) * speed * Time.fixedDeltaTime; // Move Right
                else rb.linearVelocity = new Vector2(-1, RANDOM_Y) * speed * Time.fixedDeltaTime; // Move Left
            }
        }
